package com.example.Nimap.NimapProject.Controller;
...
import com.example.Nimap.NimapProject.Service.CategoryService;
...
public class Category {
	...
	public ResponseEntity<List<com.example.Nimap.NimapProject.Entity.Category>> getAllCategory() {
	    List<com.example.Nimap.NimapProject.Entity.Category> categories = cs.getAll();
	...
	public ResponseEntity<Category> getCategorybyId(@PathVariable("C_id") Long C_id){
		...
		com.example.Nimap.NimapProject.Entity.Category ci;  // Creating The variable of category with absolute Path
	...
	public ResponseEntity<Category> addCategory(@RequestBody com.example.Nimap.NimapProject.Entity.Category c){
	...
	public ResponseEntity<Category>updateCategory(@RequestBody com.example.Nimap.NimapProject.Entity.Category ci1,@PathVariable("C_id")Long C_id){
