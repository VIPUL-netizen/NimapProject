...
import com.example.Nimap.NimapProject.Service.ProductService;
...
public class Product {
	...
	//---------Getting Method-----------------------------------------//
		...
		@GetMapping("/products")
		public ResponseEntity<List<com.example.Nimap.NimapProject.Entity.Product>> getAllCategory() 
		{
		    List<com.example.Nimap.NimapProject.Entity.Product> product = ps.getAllProduct();
		...
		public ResponseEntity<Product> getProductbyId(@PathVariable("P_id") Long P_id){
			...
			com.example.Nimap.NimapProject.Entity.Product Pi;  // Creating The variable of category with absolute Path
		...
		public ResponseEntity<Product> addProduct(@RequestBody com.example.Nimap.NimapProject.Entity.Product Pi){
		...
		public ResponseEntity<Product>updateProduct(@RequestBody com.example.Nimap.NimapProject.Entity.Product Pi1,@PathVariable("P_id")Long P_id){
